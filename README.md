...
## 🎨 Frontend 🎨
 - add the 'quarkus-qute-web' extension [1.36-add-quarkus-qute-ext.sh](./jarvis-app/1.35-add-quarkus-qute-ext.sh)
 ...
 - add `quarkus-websockets-next` extension: [1.41-add-quarkus-websocket-ext.sh](./jarvis-app/1.41-add-quarkus-websocket-ext.sh)
